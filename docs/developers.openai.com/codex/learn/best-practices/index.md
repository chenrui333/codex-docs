...
[`config.toml`](/codex/config-basic) is where you define durable preferences such as MCP servers, profiles, multi-agent setup, and experimental features. You can edit it directly or ask Codex to update it for you.
...
Use Codex’s [multi-agent](/codex/concepts/multi-agents) workflows to offload
