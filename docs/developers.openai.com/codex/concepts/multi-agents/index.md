...
This page explains the core concepts and tradeoffs. For setup, agent configuration, and examples, see [Multi-agents](/codex/multi-agent).
...
subscribers. See [Models](/codex/models) for current availability. If you’re
