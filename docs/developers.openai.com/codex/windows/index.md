...
The easiest way to use Codex on Windows is to use the [Codex app](/codex/app/windows). You can also [set up the IDE extension](/codex/ide) or [install the CLI](/codex/cli) and run it from PowerShell.
