...
# Redirecting to: /codex/use-cases/collections/web-development

Source: https://developers.openai.com/codex/tracks/web-development

[Redirecting from `/codex/tracks/web-development/` to `/codex/use-cases/collections/web-development`](/codex/use-cases/collections/web-development)
