...
iOS  Code](/codex/use-cases/ios-liquid-glass)[![](/images/codex/codex-wallpaper-2.webp)

### Analyze datasets and ship reports

Turn messy data into clear analysis and visualizations.

Data  Analysis](/codex/use-cases/datasets-and-reports)[![](/images/codex/codex-wallpaper-3.webp)

### Automate bug triage

Turn daily bug reports into a prioritized list, then automate the sweep.

Automation  Quality](/codex/use-cases/automation-bug-triage)[![](/images/codex/codex-wallpaper-1.webp)
...
macOS  Code](/codex/use-cases/macos-sidebar-detail-inspector)[![](/images/codex/codex-wallpaper-3.webp)
...
macOS  Code](/codex/use-cases/native-macos-apps)[![](/images/codex/codex-wallpaper-2.webp)

### Build responsive front-end designs

Turn screenshots and visual references into responsive UI with visual checks.

Front-end  Design](/codex/use-cases/frontend-designs)[![](/images/codex/codex-wallpaper-2.webp)
...
iOS  Code](/codex/use-cases/ios-simulator-bug-debugging)[![](/images/codex/codex-wallpaper-3.webp)
...
Engineering  Analysis](/codex/use-cases/iterate-on-difficult-problems)[![](/images/codex/codex-wallpaper-2.webp)
...
iOS  Code](/codex/use-cases/ios-swiftui-view-refactor)[![](/images/codex/codex-wallpaper-1.webp)
...
Engineering  Workflow](/codex/use-cases/reusable-codex-skills)[![](/images/codex/codex-wallpaper-2.webp)

### Turn Figma designs into code

Turn Figma selections into polished UI with structured design context and visual checks.

Front-end  Design](/codex/use-cases/figma-designs-to-code)[![](/images/codex/codex-wallpaper-1.webp)

### Understand large codebases

Trace request flows, map unfamiliar modules, and find the right files fast.

Engineering  Analysis](/codex/use-cases/codebase-onboarding)[![](/images/codex/codex-wallpaper-3.webp)
