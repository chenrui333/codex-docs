...
- Treat `docs/codex_capabilities.json`, `docs/developers.openai.com/**`, `docs/github.openai.com/**`, `docs/platform.openai.com/**`, `dot_codex/skills/dot_system/**`, and `system_prompts/codex-cli/**` as generated output.
